...
- (void)setItemModels:(NSArray *)itemModels
{
   ...
   _itemModels = itemModels;
    ...
    if (self.infiniteLoop && itemModels.count > 2 && nil == self.firstItemModel && nil == self.lastItemModel) {
        self.firstItemModel = (NSObject<TangramItemModelProtocol> *)[self.itemModels firstObject];
        self.lastItemModel = (NSObject<TangramItemModelProtocol> *)[self.itemModels lastObject];
